  ...
  return (
    <View className="border border-fog bg-paper p-4">
      ...
      <View className="mt-4 flex-col gap-3 lg:flex-row lg:items-end">
        <DatePickerField label="Training date" value={scheduledDate} onChangeText={setScheduledDate} />
        ...
        <DatePickerField label={`Move ${weekName} from`} value={weekStartDate} onChangeText={setWeekStartDate} accessibilityLabel={`New start date for ${weekName}`} />
