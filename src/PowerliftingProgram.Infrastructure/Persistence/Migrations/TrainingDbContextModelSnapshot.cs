...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("PowerliftingProgram.Domain.Entities.AthleteProfile", builder =>
        {
            ...
            builder.Property<string>("CompetitionAgeDivision").IsRequired().HasMaxLength(32).HasColumnType("character varying(32)");
            ...
            builder.Property<DateOnly?>("DateOfBirth").HasColumnType("date");
            builder.Property<int>("Equipment").HasColumnType("integer");
            builder.Property<int>("Experience").HasColumnType("integer");
            ...
            builder.Property<string>("FederationCode").IsRequired().HasMaxLength(32).HasColumnType("character varying(32)");
        ...
        modelBuilder.Entity("PowerliftingProgram.Domain.Entities.TrainingBlock", builder =>
        {
            ...
            builder.Property<string>("Name").IsRequired().HasMaxLength(160).HasColumnType("character varying(160)");
            builder.Property<Guid?>("ProgramTemplateId").HasColumnType("uuid");
            builder.Property<DateTimeOffset?>("RespondedAt").HasColumnType("timestamp with time zone");
            builder.Property<byte[]>("RowVersion").IsConcurrencyToken().HasColumnType("bytea");
